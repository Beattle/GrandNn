...
// Released under HTMLArea3 XTD License
...
//	this.width = "100%";
	...
	this.fullPage = false;
	this.pageStyle = '/style/style.css';
...
//			html += '<base href="' + editor.config.baseURL + '" />\n';
			...
			html += "<link href=\"/styles/styles.css\" rel=\"stylesheet\" type=\"text/css\">\n";
			html += "</head>\n";
			html += "<body>\n";
...
HTMLArea.prototype._preview = function() {
	...
	+ myWindow.document.write('<head>\n<title>' + HTMLArea.I18N.preview["Preview"] + '</title>\n');
	+ myWindow.document.write('<style type=\"text/css\">' + this.config.pageStyle + '</style>\n</head>\n');
	+ myWindow.document.write(this.getInnerHTML());
	+ myWindow.document.write('\n<br />\n<br />\n<div align=\"center\"><a href=\"javascript:self.close();\">' + HTMLArea.I18N.preview["Close this window"] + '</a></div><br />\n');
...
HTMLArea.prototype.imgURL = function(file, plugin) {
	if (typeof plugin == "undefined")
		...
		return _editor_url + "plugins/" + plugin + "/imglib/" + file;
};
