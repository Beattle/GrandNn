...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	include_once($_SERVER['DOCUMENT_ROOT'].'/conf.phtml');
	$_CONF['upload_path'] = '/imglib/';
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../..'.$_CONF['upload_path']); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH',    '../../../..'.$_CONF['upload_path']);	//accept relative path only	define('CONFIG_SYS_FOLDER_SHOWN_ON_TOP', true); //show your folders on the top of list if true or order by name 
