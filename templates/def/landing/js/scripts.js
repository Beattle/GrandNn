...
$(document).ready(function(){
		$('a.q').click(function(){
			$(this).next('.a').toggle(500);
			// $('.a').slideUp(500); // при одном открытом окне
			// $(this).next('.a').slideDown(500);
			return false;
		});
	});
// нажатие на банер и открытие вопроса
$(document).ready(function(){
		$('a.b1').click(function(){
			$('.a#6').slideDown(500);
			// $('.a').slideUp(500); // при одном открытом окне
...
$(function () {
	var elWrap = $('#slider-feedback'),
		el =  elWrap.find('iframe'),
		indexImg = 1,
		indexMax = el.length,
		phase = 5000;
	...
	elWrap.append('<span class="next1"></span><span class="prev1"></span>');
	var	btnNext = $('span.next1'),
		btnPrev = $('span.prev1');
