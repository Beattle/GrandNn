...
var percentOver2 = [1.71,1.71,1.71,2.28,2.85,3.2,3.4,3.6,3.8,4.0,4.1,4.2,4.3,4.4,4.5,4.6,4.7,4.8,4.9,5.0,5.1,5.2,5.3,5.4,5.5,5.6,5.7,5.8,5.9,6.0,6.2,6.4,6.6,6.8,7.0,7.2,7.4,7.6,7.8,8.0,8.2,8.4,8.6,8.8,9.0,9.2,9.4,9.6,9.8,10.0,10.2,10.4,10.6,10.8,11.0,11.2,11.4,11.6,11.8,12.0];
var re = /(?=\B(?:\d{3})+(?!\d))/g;
$(function() {
  $( "#slider1" ).slider({
    range: "min",	  
	...
	slide: function( event, ui ) {
				...
				if(set_sum < 30000 ) var percentCur = percentOver[set_days-1]
				else var percentCur = percentOver2[set_days-1]
				set_percent = Math.round( set_sum * percentCur/100 );
