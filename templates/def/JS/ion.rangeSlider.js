            ...
            return this.each(function(){
                ...
                var getNumbers = function(){
                    ...
                    if(settings.type === "single") {
                        ...
                        if(settings.changeDiapason){
	                        if (nums.fromX <= 97){
	                        	nums.fromNumber = 100 * nums.fromX + parseInt(settings.min);
	                        } else if(nums.fromX <= 137){
	                        	nums.fromNumber = 9700 + 500 * (nums.fromX - 97) + parseInt(settings.min);
                        		}else if(nums.fromX <= 187){
                        		nums.fromNumber = 29700 + 1000 * (nums.fromX - 137) + parseInt(settings.min);
                        		}else if(nums.fromX <= 250){
                        		nums.fromNumber = 79700 + 5000 * (nums.fromX - 187) + parseInt(settings.min);
                        	}else{
