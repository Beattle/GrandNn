...
<!-- Добавить -->
<p><A  HREF='javascript:;' OnClick='ShowPopUp("/clear/subscr/admin", 800, 600, "yes");'><IMG SRC='<?=KAT::inc_link('a_add.gif', $tmp)?>' BORDER='0' ALT='Новая рассылка'  align=left>Новая рассылка</A></p>
<?
// Функция импорта
