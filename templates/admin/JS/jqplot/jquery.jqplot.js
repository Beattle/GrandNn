...
(function($) {
    ...
    */
    ...
    jsDate.regional = {
        ...
        'ru': {monthNames:["ßíâàðü","Ôåâðàëü","Ìàðò","Àïðåëü","Ìàé","Èþíü","Èþëü","Àâãóñò","Ñåíòÿáðü","Îêòÿáðü","Íîÿáðü","Äåêàáðü"],monthNamesShort:["ßíâ","Ôåâ","Ìàð","Àïð","Ìàé","Èþí","Èþë","Àâã","Ñåí","Îêò","Íîÿ","Äåê"],dayNames:["Ïîíåäåëüíèê","Âòîðíèê","Ñðåäà","×åòâåðã","Ïÿòíèöà","Ñóááîòà","Âîñðåñåíüå"],dayNamesShort:["Ïí","Âò","Ñð","×ò","Ïò","Ñá","Âñ"],formatString:"%d.%m.%Y %H:%M:%S"},
