...
<!-- Добавить -->
<p><A  HREF='javascript:;' OnClick='ShowPopUp("/clear/<?=$_KAT['MODULE_NAME']?>/<?=$_KAT['KUR_ALIAS']?>/add?edit&<?=$_SERVER['QUERY_STRING']?>", 800, 600, "yes");'><IMG SRC='<?=KAT::inc_link('a_add.gif', $tmp)?>' BORDER='0' ALT='Задать вопрос'  align=left>Задать вопрос</A></p>
<?
// Функция импорта
