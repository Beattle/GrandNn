...
<!--Редактировать -->
<a href='javascript:;' onclick='if(shift_pressed_on==-1){shift_pressed_on=CurrentMarked;isp=true;}EnterPressed();if(isp)shift_pressed_on=-1;return false;'><img SRC='<?=KAT::inc_link('a_edit.gif', $tmp)?>' BORDER='0'  align='left' ALT='редактировать'>Подробный просмотр</a>
<?endif;?>
</div>
